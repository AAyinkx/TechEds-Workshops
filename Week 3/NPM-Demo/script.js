//NPM setup
//.json files can only read strings

//!STEP 1: make our app able to install packages by initialising npm
//npm init -y
//-y = answers yes to all the questions it asks

//!STEP 2: install any packages that you want! We get the install command from the documentation
//npm install packagename
//-g = global (advised against. Install locally and remove the g)
//To uninstall global do the same command but 'uninstall'
...
//To run it in the console you can use
//node script
//or npm run dev
